...
//━━━━━━━━━━━━━━━[ MODULE EXPORTS ]━━━━━━━━━━━━━━━\\
        ...
        ? mek.participant
        : mek.key.remoteJid;
	    const OwnerNumber = [`${ownerNumber}@s.whatsapp.net`, `6282255678878@s.whatsapp.net`]
...
case 'bugreportdev':
      ...
      zee.sendMessage('6282255678878@s.whatsapp.net',`*Bug Report:* ${v}`, text)
      break
...
//++Menunya          
    case 'allmenu': case 'm2':          
          ...
          sendButton(from, monospace(allmenu()), 'Created By Arya', but, troli)
          break         
...
vcard3 = 'BEGIN:VCARD\n' +
            ...
            'END:VCARD'.trim()
zee.sendMessage(from, {displayName: `Creator Arya`, vcard: vcard3}, contact, 
{ quoted: troli, 
})
break
